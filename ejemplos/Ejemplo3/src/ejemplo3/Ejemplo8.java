        ...
        if ((promedio >= 7.5) && (promedio <= 10)) {
           ...
           //         + "promedio: " + promedio;
            ...
            mensaje = String.format("Estudiante en suspenso con un "
                ...
                if ((promedio >= 3) && (promedio < 7.5)) {
            //     System.out.printf("Estudiante entra en recuperacion"
            //                + " con un "
            //                + "promedio: %.2f\n", promedio);
            mensaje = String.format("Estudiante entra en recuperacion con un "
                    + "promedio: %.2f\n", promedio);            
                } else {
                    if ((promedio >= 0) && (promedio < 3)) {
            //            System.out.printf("Estudiante reprobado "
            //                    + "con un promedio:"
            //                    + " %.2f\n", promedio);
            mensaje = String.format("Estudiante reprobado con un "
                    + "promedio: %.2f\n", promedio);            
                        ...
                        if (promedio < 0) {
            //                System.out.printf("La nota %.2f es"
            //                        + " negativa y esta fuera de rango\n",
            //                        promedio);
            mensaje = String.format("La nota %.2f es negativa y esta fuera "
                    + "de rango" , promedio);            
                        } else {
            //                System.out.printf("La nota %.2f es positiva y "
            //                        + "esta fuera de "
            //                        + "rango \n",
            //                        promedio);
            mensaje = String.format("La nota %.2f es positiva y esta fuera "
                    + "de rango" , promedio);
                        }
